...
**축 요약** — 아래 WBS 표의 축 열을 합산한 값이라 따로 관리하지 않습니다: 유실방지 67% · 공격방어 72% · 약속이행 40% · 경험설계 36% · 기반구축 96%.
